# BBR v3 优化脚本 - Ultimate Edition v5.0.0 (CodeEagle fork)
...
```bash
# 安装别名
bash <(curl -fsSL "https://raw.githubusercontent.com/CodeEagle/vps-tcp-tune/main/install-alias.sh?$(date +%s)")
...
bash <(curl -fsSL "https://raw.githubusercontent.com/CodeEagle/vps-tcp-tune/main/net-tcp-tune.sh?$(date +%s)")
```

### 方式3：下载到本地

```bash
wget -O net-tcp-tune.sh "https://raw.githubusercontent.com/CodeEagle/vps-tcp-tune/main/net-tcp-tune.sh?$(date +%s)"
...
本脚本包含 **33** 项功能，涵盖内核优化、网络加速、代理部署、系统管理、安全加固等全方位需求。
...
|  28  | F 佬一键 sing box 脚本 | 全能代理工具（已指向 [CodeEagle/sing-box](https://github.com/CodeEagle/sing-box) 含 IPv6 双栈 post-processor） |
...
[![GitHub stars](https://img.shields.io/github/stars/CodeEagle/vps-tcp-tune?style=social)](https://github.com/CodeEagle/vps-tcp-tune)

## Star History

<a href="https://star-history.com/#CodeEagle/vps-tcp-tune&Date">
  <img src="https://api.star-history.com/svg?repos=CodeEagle/vps-tcp-tune&type=Date" alt="Star History Chart" width="600">
</a>
